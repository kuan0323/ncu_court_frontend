  ...
  return (
        ...
        <div className="h-full w-full col">
            ...
            <div className="h-16 text-background text-center">
                ...
                <div className="grid gap-4 grid-cols-2 grid-rows-2 place-items-stretch">
                        <div className="static max-w-sm bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700 place-items-stretch">
                        ...
                        <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700 object-center">
