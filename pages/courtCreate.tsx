                ...
                <div className="flex-col p-4 w-full mx-8">
                    ...
                    <form encType="form-data">
                        ...
                        <div className="mb-3 w-96 flex space-x-4 justify-end mt-5">
                            <div className="">
                                <button type="button" onClick={() => createCourt()} className="inline-block px-6 py-2.5 bg-[#69CBBF] text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-[#40948A] hover:shadow-lg focus:bg-[#40948A] focus:shadow-lg focus:outline-none focus:ring-0 active:bg-[#40948A] active:shadow-lg transition duration-150 ease-in-out">確認</button>
                            </div>
                        </div>
                    </form>
                </div>
