...
export default function editAccount() {
    ...
    const editHandler = async () => {
        ...
        // const token = Cookies.get('service_token'); //Add this line
        // console.log(token);
        ...
        const edit = await UserService.editUsers("EE", "1111111111", "11@11", "12345", "12345");
        ...
        <div className="bg-white">
            ...
            <div className=" col-span-2 row-span-1 text-background place-items-center">
                <div className="flex md:flex-col justify-center items-center mt-40 ">
                    ...
                    <button onClick={() => editHandler()} className="w-full text-white bg-blue-700">Test</button>
