                    ...
                    <div className="shadow-md w-full bg-white rounded-lg p-12 flex flex-col justify-center items-center">
                        ...
                        <div className="text-center">
                            ...
                            <ul className="mt-3 flex flex-wrap">
                                <div className="p-5">
                                    <a href="#" className="text-decoration-none inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                        查看場地
