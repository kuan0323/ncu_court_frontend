                      ...
                      <tr className="border-b">
                        ...
                        <td className="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                          <div className="flex space-x-4 ">
                            <button
                              onClick={() => deleteHandler(court.id)}
                              type="button"
                                ...
                                {message.map((message: any) => (
                                  <tbody key={message.content}>
                                    <tr className="relative transform scale-100 py-1 whitespace-no-wrap border-b-2 border-blue-100 cursor-default">
                                      <td>
                                        <div className="text-left px-2 py-1 leading-5 text-gray-500 text-lg">
                                          {message.user.name}
                                        </div>
                                        <div className="text-left px-2 py-1 leading-5 text-gray-900 w-full whitespace-normal text-lg">
                                          {message.content}
                                        </div>
                  ...
                  >
                    <Dialog.Panel className="flex transform transition md:my-8 md:max-w-2xl md:px-4 lg:max-w-4xl">
                      <div className="relative flex w-full items-center overflow-hidden bg-white px-4 pt-14 pb-8 shadow-2xl sm:px-6 sm:pt-8 md:p-6 lg:p-8">
                        ...
                        <div>
                          <div className="flex-col p-4 w-full mx-8">
                            <h2 className="text-lg text-gray-700 mt-2 text-left">
                              修改場地
                            </h2>
                            ...
                            <form encType="form-data">
                              <div className="flex justify-start">
                                <div className="mb-3 xl:w-96">
                                  {/* 場地名稱 */}
                                  <label className="form-label inline-block mb-2 text-gray-700 ml-2 mt-5">
                                    場地名稱
                                  </label>
                                  <input
                                    value={name}
