...
export default function EditAccount() {
  ...
  return (
    <div className="bg-white h-screen">
      <div>
        <NavBar mainPage={false} myReserve={false} myAccount={true}></NavBar>
      </div>
                        ...
                        <div className="flex gap-5">
                          <div className="w-full">
                            ...
                            <input
                              ...
                              name="name"
                              id="name"
                              className="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                            />
                          </div>
                          <div className="w-full">
                            <label
